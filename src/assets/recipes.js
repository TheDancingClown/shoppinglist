...
const recipes = [
  {
    ...
    "thumbnail": require('./pst&c&ckr.jpg'),
    "ingredients": {
      "kale (g)": 80,
      "carrots (g)": 200,
      "spring onions": 2,
      "coriander, fresh (handful)": 1,
      "chilli, red": 0.5,
      "ginger (cm)": 4,
      "limes": 1,
      "rice, brown (g)": 80,
  ...
  },
  {
    ...
    "thumbnail": require('./wis&cc&r.jpg'),
    "ingredients": {
      "broccoli (head)": 1,
      "spinach, baby (g)": 160,
      "peppers, red": 2,
